...
model_path = './save_models/retrieval_models/1'
...
open("converted_model_retrieval.tflite", "wb").write(tflite_model)

interpreter = tf.lite.Interpreter(model_path="converted_model_retrieval.tflite")
...
# Test the model.
if input_details[0]["name"] == "serving_default_kriteria_mentor_user:0":
